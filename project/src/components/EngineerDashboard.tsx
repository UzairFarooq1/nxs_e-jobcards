...
export function EngineerDashboard({ onCreateJobCard }: EngineerDashboardProps) {
  ...
  if (isLoading) {
    return (
      <LoadingSpinner message="Loading job cards..." size="lg" variant="bars" />
    );
  }
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-50/30 via-transparent to-cyan-50/30 rounded-3xl -m-4"></div>
